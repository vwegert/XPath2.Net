...
{
    internal sealed class Int : ValueProxy
    {
        ...
        {
            return new Int(_value + ((Int)val)._value);
        }
        ...
        {
            return (Integer)Convert.ToDecimal(_value / Convert.ToInt32(val));
        }
