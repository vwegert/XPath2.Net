...
{
    internal sealed class Short : ValueProxy
    {
        ...
        {
            return _value == ((Short)val)._value;
        }
        ...
        {
            return (Integer)Convert.ToDecimal(_value / Convert.ToInt16(val));
        }
