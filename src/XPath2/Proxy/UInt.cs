...
{
    internal sealed class UInt : ValueProxy
    {
        ...
        {
            return new UInt(Convert.ToUInt32(val));
        }
        ...
        {
            return new UInt(_value + ((UInt) val)._value);
        }
        ...
        {
            return (Integer) Convert.ToDecimal(_value/Convert.ToUInt32(val));
        }
