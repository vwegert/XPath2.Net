...
{
    private readonly Dictionary<FunctionDesc, XPathFunctionDef> _funcTable;
    ...
    {
        if (!_funcTable.TryGetValue(new FunctionDesc(name, ns, arity), out var res))
        {
