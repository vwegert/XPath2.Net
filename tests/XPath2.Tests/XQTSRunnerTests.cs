...
{
    private const string Uri = "https://github.com/StefH/XML-Query-Test-Suite-1.0/blob/main/XQTS_1_0_2.zip?raw=true";

    private readonly string _passedPath = Path.Combine(Environment.CurrentDirectory, "passed.txt");
    private readonly List<string> _expectedPassed = new();
